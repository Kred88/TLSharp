...
namespace TLSharp.Core.MTProto
{
    ...
    public class DisabledFeatureConstructor : DisabledFeature
    {
        ...
        public override void Write(BinaryWriter writer)
        {
            ...
            Serializers.String.write(writer, this.feature);
            Serializers.String.write(writer, this.description);
        }

        public override void Read(BinaryReader reader)
        {
            this.feature = Serializers.String.read(reader);
            this.description = Serializers.String.read(reader);
        }
